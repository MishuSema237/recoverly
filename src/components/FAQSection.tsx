    ...
    <section className="py-20 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <span className="text-navy-600 font-bold tracking-wider uppercase text-sm">Common Questions</span>
          ...
          {faqs.map((faq, index) => (
            ...
            >
              <button
                ...
                className="w-full px-8 py-6 text-left flex items-center justify-between hover:bg-navy-100 transition-colors duration-200"
              >
                <h3 className="text-lg font-bold text-navy-900 pr-4 font-playfair">
                  {faq.question}
                </h3>
              ...
              <AnimatePresence>
                {openIndex === index && (
                  ...
                  >
                    <div className="px-8 pb-6 bg-white border-t border-navy-100">
        ...
        <div className="mt-16 text-center">
          <div className="bg-navy-900 rounded-2xl p-8 text-white relative overflow-hidden">
            ...
            <h3 className="text-2xl font-bold mb-4 font-playfair relative z-10">
              Still have questions?
            </h3>
            <p className="text-navy-100 mb-6 relative z-10">
              Our legal team is ready to review your case for free.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
              <a
                href="/contact"
                className="bg-gold-500 text-navy-900 px-6 py-3 rounded-lg font-bold hover:bg-gold-400 transition-colors duration-200"
              >
