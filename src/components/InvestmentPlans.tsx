...
import { CheckCircle, Star, Zap, Crown, Gem, AlertCircle, TrendingUp, Diamond, Rocket, Shield, Gift, Target, Trophy, Flame, RefreshCw, ChevronLeft, ChevronRight } from 'lucide-react';
